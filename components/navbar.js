...
<div class="dropdown hide">
    <div class="sub-menu">
        ...
        <a href="#"><button id="sign-in-btn">Sign ln</button></a>
        <a href="#"><button id="sign-up-btn">Create Account</button></a>
    </div>
</div>`
}
